...
export interface ErrorResponse {
  /**
   * This error code should have the format 'CLA-XXX' where XXX is an integer. It is used to uniquely distinguish different error cases in order to display a suitable and translatable error message on the UI.
   */
  code: string;
  /**
