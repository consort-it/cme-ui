...
export class CostsService {
   ...
   */
  public getCosts(month: number, year: number, observe?: 'body', reportProgress?: boolean): Observable<AwsCosts>;
  public getCosts(
    month: number,
    year: number,
    observe?: 'response',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getResourceGroups(observe?: 'body', reportProgress?: boolean): Observable<ResourceGroup>;
  public getResourceGroups(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResourceGroup>>;
  public getResourceGroups(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResourceGroup>>;
  public getResourceGroups(observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    let headers = this.defaultHeaders;
